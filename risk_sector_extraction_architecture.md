...
최종적으로 LLM은 위 두 증거를 합쳐 **가장 위험한 섹터/테마와 회피 종목(2~3개)**을 경고한다.
...
- `representative_etfs` (1~2개)
- `leader_stocks` (2~3개)
- `structural_driver`
- `sentiment`

### Step B-2. 테마 시장 신호 부착
테마 ETF + 대장주에 대해 RSI/MA 이격도를 포함한 신호를 부착한다.
...
1. `위험 테마: [테마명 또는 위험 군집명]`
2. `리스크 근거: [FRED/yfinance/Tavily 기반 2문장 요약]`
3. `피해야 할 종목: [Ticker 2~3개] 및 사유`
